...
public final class QueryUtils {
    ...
    public static ArrayList<customEarthQuake> extractEarthquakes() {

        // Create an empty ArrayList that we can start adding earthquakes to
        ArrayList<customEarthQuake> earthquakes = new ArrayList();
        ...
        try {
            ...
            JSONObject propertiesJsonObject = currentEarthQuake.getJSONObject("properties");
            ...
            if(location.contains("of")){
                ...
                List<String> arraylist = Arrays.asList(location.split("of"));
                location1 = arraylist.get(0)+"of";
                location2 = arraylist.get(1);
            }else{
                ...
                List<String> arraylist = Arrays.asList(dateToDisplay.split(","));
                String number1 = arraylist.get(0);
                String number2 = arraylist.get(1);
                customEarthQuake earthQuake=new customEarthQuake(magnitude,location1,location2,number1,number2,url);
